...
<head>
  ...
  <title>BOSTARTER - Dashboard Creatore</title>
...
<body class="bg-gray-100">
  ...
  <div class="max-w-5xl mx-auto mt-10">
    <h2 class="text-3xl font-bold mb-6 text-gray-800">Dashboard Creatore</h2>
    ...
    <div class="grid gap-6 md:grid-cols-2">
      ...
      <div class="bg-white rounded shadow p-4">
        <h3 class="text-xl font-semibold text-blue-700">Smart Plant Monitor</h3>
        <p class="text-gray-600 mb-2">Sensore per monitorare le piante da remoto</p>
      ...
      <!-- Altro progetto di esempio -->
      <div class="bg-white rounded shadow p-4">
        <h3 class="text-xl font-semibold text-blue-700">AI Assistant Bot</h3>
        <p class="text-gray-600 mb-2">Bot intelligente per supporto clienti</p>
